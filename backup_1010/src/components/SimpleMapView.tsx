...
interface YandexMaps {
  ...
  Map: new (element: string | HTMLElement, options?: any) => YandexMap
  Placemark: new (coords: [number, number], properties?: any, options?: any) => YandexPlacemark
}
...
export default function SimpleMapView({ events, cityCenter, cityName }: SimpleMapViewProps) {
