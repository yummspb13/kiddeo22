...
export default function LoginModal({ isOpen, onClose }: LoginModalProps) {
  ...
  return (
    <div 
      className={`fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-black/10 via-black/20 to-black/30 backdrop-blur-md transition-all duration-200 ${
      ...
      <div className={`bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto ring-1 ring-white/10 transition-all duration-200 ${
        ...
        <div className="p-6">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="modal-email" className="block text-sm font-medium text-gray-700 mb-1" style={{ fontFamily: 'var(--font-unbounded)' }}>
                Email
              </label>
              <input
                id="modal-email"
            ...
            <div>
              <label htmlFor="modal-password" className="block text-sm font-medium text-gray-700 mb-1" style={{ fontFamily: 'var(--font-unbounded)' }}>
                Пароль
              </label>
              <input
                id="modal-password"
