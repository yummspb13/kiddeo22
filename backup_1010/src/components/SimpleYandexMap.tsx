        ...
        marker.coordinates,
        {
          ...
          balloonContentBody: `
            <div style="padding: 10px;">
              ...
              <p><strong>Дата:</strong> ${new Date(marker.event.startDate).toLocaleDateString('ru')}</p>
              <p><strong>Категория:</strong> ${marker.event.category || 'Не указана'}</p>
            </div>
          `,
          balloonContentFooter: `<a href="/city/moskva/event/${marker.event.slug}" target="_blank">Подробнее</a>`
        },
        {
          preset: 'islands#redIcon'
        }
