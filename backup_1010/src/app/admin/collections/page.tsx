...
export default function CollectionsAdminPage() {
  ...
  const handleToggleHideFromAfisha = async (id: string, hideFromAfisha: boolean) => {
    try {
      const response = await fetch(`/api/admin/collections/${id}?key=kidsreview2025`, {
        method: 'PATCH',
        headers: {
        ...
        body: JSON.stringify({ hideFromAfisha: !hideFromAfisha })
      })
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">Создавайте и управляйте подборками событий</p>
            </div>
            <Link
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {collections.map((collection) => (
                  <tr key={collection.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <button
                        onClick={() => handleToggleHideFromAfisha(collection.id, collection.hideFromAfisha)}
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                      ...
                      >
                        {collection.hideFromAfisha ? 'Скрыта' : 'Показана'}
                      </button>
                    </td>
        ...
        {collections.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              Создайте первую подборку событий для ваших пользователей
            </p>
            <Link
              href="/admin/collections/create?key=kidsreview2025"
              className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
