  ...
  try {
    ...
    const collection = await prisma.collection.create({
      data: {
        ...
        showInVenues: showInVenues !== undefined ? showInVenues : false,
        showInMain: showInMain !== undefined ? showInMain : false,
        showInBlog: showInBlog !== undefined ? showInBlog : false,
        eventsTitle,
        eventsDescription,
        venuesTitle,
        venuesDescription
