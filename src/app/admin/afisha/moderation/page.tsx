                  ...
                  {item.type === 'event' && (
                    <div className="bg-gray-50 rounded-lg p-4 mb-4">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div><strong>Цена:</strong> {item.details.price && item.details.price > 0 ? `₽${item.details.price}` : 'Бесплатно'}</div>
                      </div>
                    </div>
                  )}
                  ...
                  {item.type === 'review' && (
                    <div className="bg-gray-50 rounded-lg p-4 mb-4">
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        <div className="flex">
                          {[...Array(5)].map((_, i) => (
                            <Star key={i} className={`w-4 h-4 ${i < (item.details.rating || 0) ? 'text-yellow-400 fill-current' : 'text-gray-300'}`} />
                          ))}
                        </div>
                        <span className="text-sm text-gray-600">{Number(item.details.rating || 0).toFixed(1)}/5</span>
                      </div>
                      <p className="text-sm text-gray-700 mb-2">"{item.details.content}"</p>
                      <p className="text-xs text-gray-500">К событию: {item.details.eventTitle}</p>
                    </div>
