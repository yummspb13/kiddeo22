...
export default async function AfishaAdsPage({
  ...
  const validTabs = ['HERO_BELOW', 'HEADER_BANNER', 'SIDEBAR_TOP', 'SIDEBAR', 'INLINE']
  ...
  const adPlacementTabs = ['HEADER_BANNER', 'SIDEBAR_TOP', 'SIDEBAR', 'INLINE']
  ...
  const positionLabels = {
    ...
    'SIDEBAR_TOP': 'Слева над фильтрами (400x260px)',
  ...
  const tabs = [
    ...
    { id: 'SIDEBAR_TOP', label: 'Слева над фильтрами', icon: Grid },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mt-8 bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="border rounded-lg p-4">
              <h4 className="font-medium text-gray-900 mb-2">Слева над фильтрами</h4>
