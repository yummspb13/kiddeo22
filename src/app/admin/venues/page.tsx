...
import { MapPin, Filter, Megaphone, Settings, BarChart3, MessageSquare, CreditCard } from 'lucide-react'
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <div className="flex items-center mb-4">
            ...
            <h3 className="ml-3 text-lg font-semibold text-gray-900">Тарифы</h3>
          </div>
          <p className="text-gray-600 text-sm">
            Управление тарифами и подписками для мест
          </p>
          <div className="mt-4 flex items-center text-sm text-green-600 group-hover:text-green-700">
