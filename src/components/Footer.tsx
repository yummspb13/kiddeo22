...
export default function Footer({ citySlug = 'moscow' }: Props) {
      ...
      <div className="w-full px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="hover:opacity-80 transition-opacity cursor-pointer block mb-4">
              <img
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href={`/${citySlug}/events`} className="text-gray-400 hover:text-white transition-colors cursor-pointer">
                  Афиша
                </Link>
              </li>
              <li>
