  ...
  return (
    <div className="space-y-3">
      ...
      {paginatedActivities.map((activity) => (
        <div key={activity.id}>
          {/* Десктопная версия */}
          <div className="hidden md:flex items-center space-x-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
          ...
          {/* Мобильная версия */}
          <div className="md:hidden profile-activity-mobile">
            <div className="profile-activity-dot-mobile"></div>
            <div className="profile-activity-content-mobile">
              <div className="profile-activity-action-mobile">
                {activity.action}
              </div>
              <div className="profile-activity-date-mobile">
              ...
              <div className="profile-activity-title-mobile">
                <Link 
                  href={`/event/${activity.slug}`}
              ...
              <div className="profile-activity-footer-mobile">
                <div className="profile-activity-stars-mobile">
                  {renderStars(activity.rating)}
                </div>
                <Link
                  href={`/event/${activity.slug}`}
                  className="profile-activity-view-mobile"
                  title="Посмотреть событие"
                >
                  <Eye className="w-3 h-3" />
                </Link>
                <span className={`profile-activity-status-mobile ${activity.status.toLowerCase()}`}>
                  {getStatusText(activity.status)}
                </span>
              </div>
            </div>
