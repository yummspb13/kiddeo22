...
export function EventCardWithCart({ 
  ...
  const formatDate = (dateString: string) => {
    try {
      ...
      if (Number.isNaN(date.getTime())) {
        console.warn('Invalid date in EventCardWithCart formatDate:', dateString)
      ...
      console.error('Error formatting date in EventCardWithCart:', dateString, error)
      return 'Дата не указана'
    }
  };
  ...
  const formatTime = (dateString: string) => {
    try {
      const date = new Date(dateString);
      if (Number.isNaN(date.getTime())) {
        console.warn('Invalid date in EventCardWithCart formatTime:', dateString)
      ...
      console.error('Error formatting time in EventCardWithCart:', dateString, error)
      return 'Время не указано'
    }
  };
