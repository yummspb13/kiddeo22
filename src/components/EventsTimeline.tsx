...
export default function EventsTimeline({ 
  ...
  const handleWeekendClick = () => {
    console.log('🔵 Кнопка "В эти выходные" нажата для города:', citySlug)
    ...
    // НЕ сбрасываем пагинацию для фильтра "В эти выходные"
  ...
  return (
    <>
      ...
      <div className="flex space-x-2 mb-6 overflow-x-auto">
        {/* Кнопка "Все" */}
        <button 
          className={`px-4 py-2 rounded-lg whitespace-nowrap transition-colors min-w-[90px] text-center ${
            !isDateSelected 
        ...
        {Array.from({ length: 17 }, (_, i) => {
          ...
          return (
            <button
              key={i}
              className={`relative px-4 py-2 rounded-lg whitespace-nowrap transition-colors min-w-[90px] text-center ${
                isSelected 
                  ? 'bg-red-600 text-white hover:bg-red-700' 
                  : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
